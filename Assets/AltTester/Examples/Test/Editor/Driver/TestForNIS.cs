...
public class TestForNIS
{
    ...
    public void TestScrollElement()
    {
        ...
        altUnityDriver.Scroll(new AltVector2(-3000, -3000), 0.5f, true);
    ...
    public void TestKeyDownAndKeyUp()
    {
        altUnityDriver.LoadScene(scene10);
        var player = altUnityDriver.FindObject(By.NAME, "Player");
        for (AltKeyCode altUnityKeyCode = AltKeyCode.Backspace; altUnityKeyCode <= AltKeyCode.F12; altUnityKeyCode++) //because F13->F15 is present in KeyCode but not in Key
            keyboardKeyDownAndUp(player, altUnityKeyCode);
        for (AltKeyCode altUnityKeyCode = AltKeyCode.Numlock; altUnityKeyCode <= AltKeyCode.Menu; altUnityKeyCode++)
            keyboardKeyDownAndUp(player, altUnityKeyCode);
        for (AltKeyCode altUnityKeyCode = AltKeyCode.Mouse0; altUnityKeyCode <= AltKeyCode.Mouse4; altUnityKeyCode++)
            if (Enum.IsDefined(typeof(AltKeyCode), altUnityKeyCode))
            {
        ...
        for (AltKeyCode altUnityKeyCode = AltKeyCode.JoystickButton0; altUnityKeyCode <= AltKeyCode.JoystickButton19; altUnityKeyCode++)
            joystickKeyDownAndUp(player, altUnityKeyCode, 1);
        for (AltKeyCode altUnityKeyCode = AltKeyCode.JoystickButton16; altUnityKeyCode <= AltKeyCode.JoystickButton19; altUnityKeyCode++) //for axis.x < 0 and axis.y < 0
            joystickKeyDownAndUp(player, altUnityKeyCode, -1);
    }

    private void keyboardKeyDownAndUp(AltObject player, AltKeyCode altUnityKeyCode)
    {
        if (Enum.IsDefined(typeof(AltKeyCode), altUnityKeyCode))
        {
            altUnityDriver.KeyDown(altUnityKeyCode);
    ...
    private void joystickKeyDownAndUp(AltObject player, AltKeyCode altUnityKeyCode, float power)
    {
    ...
    private void keyboardKeyPress(AltObject player, AltKeyCode altUnityKeyCode)
    {
        if (Enum.IsDefined(typeof(AltKeyCode), altUnityKeyCode))
        {
            altUnityDriver.PressKey(altUnityKeyCode);
    ...
    private void joystickKeyPress(AltObject player, AltKeyCode altUnityKeyCode, float power)
    {
    ...
    public void TestTilt()
    {
        ...
        altUnityDriver.Tilt(new AltVector3(5, 0, 5f), 1f);
    ...
    public void TestSwipe()
    {
        ...
        altUnityDriver.Swipe(new AltVector2(button.x + 1, button.y + 1), new AltVector2(button.x + 1, button.y + 20), 1);
    ...
    public void TestMultipointSwipe()
    {
        ...
        altUnityDriver.MultipointSwipe(new[] { new AltVector2(altElement1.x, altElement1.y), new AltVector2(altElement2.x, altElement2.y) }, 2);
    ...
    public void TestBeginMoveEndTouch()
    {
        ...
        altUnityDriver.MoveTouch(fingerId, new AltVector2(initialPanelPos.x + 200, initialPanelPos.y + 20));
