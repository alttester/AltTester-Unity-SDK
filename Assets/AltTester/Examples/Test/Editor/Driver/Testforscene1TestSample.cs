...
namespace Altom.AltDriver.Tests
{
    ...
    public class TestForScene1TestSample
    {
        ...
        {
            Assert.AreEqual("Scene 1 AltDriverTestScene", altUnityDriver.GetCurrentScene());
        }
        ...
        {
            var altElement = altUnityDriver.FindObject(By.COMPONENT, "AltExampleScriptCapsule");
        ...
        public void TestCallMethodWithMultipleDefinitions()
        {
            ...
            AltObject capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
            capsule.CallComponentMethod<string>("AltExampleScriptCapsule", "Test", new[] { "2" }, new[] { "System.Int32" }, "Assembly-CSharp");
            AltObject capsuleInfo = altUnityDriver.FindObject(By.NAME, "CapsuleInfo");
        ...
        public void TestCallMethodWithAssembly()
        {
            ...
            AltObject capsuleAfterRotation = altUnityDriver.FindObject(By.NAME, "Capsule");
        ...
        {
            List<AltComponent> components = altUnityDriver.FindObject(By.NAME, "Canvas").GetAllComponents();
        ...
        {
            AltObject cube = altUnityDriver.FindObject(By.NAME, "Cube", enabled: false);
        ...
        public void TestGet3DObjectFromScreenshot()
        {
            ...
            AltObject altUnityObject;
            altUnityDriver.GetScreenshot(new AltVector2(capsule.x, capsule.y), new AltColor(1, 0, 0, 1), 1, out altUnityObject, new AltVector2(1920, 1080));
        ...
        public void TestGetUIObjectFromScreenshot()
        {
            var capsuleInfo = altUnityDriver.FindObject(By.NAME, "CapsuleInfo");
            AltObject altUnityObject;
            altUnityDriver.GetScreenshot(new AltVector2(capsuleInfo.x, capsuleInfo.y), new AltColor(1, 0, 0, 1), 1, out altUnityObject, new AltVector2(1920, 1080));
        ...
        public void TestObjectFromScreenshot()
        {
            ...
            AltObject altUnityObject;
            altUnityDriver.GetScreenshot(offscreenCoordinates, new AltColor(1, 0, 0, 1), 1, out altUnityObject, new AltVector2(1920, 1080));
        ...
        public void TestAcceleration()
        {
            ...
            altUnityDriver.Tilt(new AltVector3(1, 1, 1), 1, wait: false);
            Thread.Sleep(1000);
        ...
        public void TestAccelerationAndWait()
        {
            var capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
            var initialWorldCoordinates = capsule.getWorldPosition();
            altUnityDriver.Tilt(new AltVector3(1, 1, 1), 1);
            Thread.Sleep(100);
            capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
            var afterTiltCoordinates = capsule.getWorldPosition();
            Assert.AreNotEqual(initialWorldCoordinates, afterTiltCoordinates);
        ...
        public void TestGetScreensizeScreenshot()
        {
            ...
            var capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
            screenshot = altUnityDriver.GetScreenshot(capsule.id, new AltColor(1, 0, 0), 1.5f);
            Assert.True(screenshot.textureSize.x == screenWidth);
            Assert.True(screenshot.textureSize.y == screenHeight);

            screenshot = altUnityDriver.GetScreenshot(capsule.id, new AltColor(1, 0, 0), 1.5f, screenShotQuality: 50);
            Assert.True(screenshot.textureSize.x == screenWidth / 2);
            Assert.True(screenshot.textureSize.y == screenHeight / 2);
        }
        [Test]
        ...
        public void TestClickWithMouse0Capsule()
        {
            ...
            Thread.Sleep(400);
            altUnityDriver.PressKey(AltKeyCode.Mouse0, 1, 0.2f);
            capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
        ...
        public void TestClickWithMouse1Capsule()
        {
            ...
            altUnityDriver.MoveMouse(capsule.getScreenPosition(), 0.1f);
            Thread.Sleep(400);
            altUnityDriver.PressKey(AltKeyCode.Mouse1, 1, 0.2f);
        ...
        public void TestClickWithMouse2Capsule()
        {
            ...
            altUnityDriver.MoveMouse(capsule.getScreenPosition(), 0.1f);
            Thread.Sleep(400);
            altUnityDriver.PressKey(AltKeyCode.Mouse2, 1, 0.2f);
            capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
            var finalCapsulePosition = capsule.getWorldPosition();
            Assert.True(FastApproximately(initialCapsulePosition.x, finalCapsulePosition.x, 0.01f));
            Assert.True(FastApproximately(initialCapsulePosition.y, finalCapsulePosition.y, 0.01f));
        ...
        {
            Assert.AreEqual(AltDriver.VERSION, altUnityDriver.GetServerVersion());
        }
        ...
        public void TestKeyPressNumberOfReads()
        {
            ...
            altUnityDriver.PressKey(AltKeyCode.LeftArrow);
        ...
        public void TestSwipeClickWhenMovedButRemainsOnTheSameObject()
        {
            var counterElement = altUnityDriver.FindObject(By.NAME, "ButtonCounter");
            var counterButtonText = altUnityDriver.FindObject(By.NAME, "ButtonCounter/Text");
            altUnityDriver.Swipe(new AltVector2(counterElement.x + 1, counterElement.y + 1), new AltVector2(counterElement.x + 2, counterElement.y + 1), 1);
            Thread.Sleep(500);
            Assert.AreEqual("1", counterButtonText.GetText());
        }
        ...
        public void TestUnloadScene()
        {
            ...
            Assert.AreEqual("Scene 1 AltDriverTestScene", altUnityDriver.GetAllLoadedScenes()[0]);
        }
        [Test]
        public void TestUnloadOnlyScene()
        {
            Assert.Throws<CouldNotPerformOperationException>(() => altUnityDriver.UnloadScene("Scene 1 AltDriverTestScene"));
        ...
        public void TestDifferentObjectSelectedClickingOnScreenshot()
        {
            ...
            altUnityDriver.GetScreenshot(uiButton.getScreenPosition(), new AltColor(1, 1, 1, 1), 1, out selectedObject);
        ...
        {
            altUnityDriver.MoveMouse(new AltVector2(0, 0));
            var counterElement = altUnityDriver.FindObject(By.NAME, "ButtonCounter");
        ...
        {
            altUnityDriver.MoveMouse(new AltVector2(-1, -1), 1);
            altUnityDriver.LoadScene("Scene 1 AltDriverTestScene", true);
            ...
            altUnityDriver.MoveMouse(new AltVector2(200, 200));
            Thread.Sleep(800);
        ...
        public void TestClickCoordinates()
        {
            var counterButton = altUnityDriver.FindObject(By.NAME, "ButtonCounter");
            var counterButtonText = altUnityDriver.FindObject(By.NAME, "ButtonCounter/Text");
            altUnityDriver.Click(new AltVector2(80 + counterButton.x, 15 + counterButton.y));
            altUnityDriver.WaitForObject(By.PATH, "//ButtonCounter/Text[@text=1]");
        }
        [Test]
        public void TestClickCoordinates_MultipleClicks()
        {
            var counterButton = altUnityDriver.FindObject(By.NAME, "ButtonCounter");
            var counterButtonText = altUnityDriver.FindObject(By.NAME, "ButtonCounter/Text");
            altUnityDriver.Click(new AltVector2(80 + counterButton.x, 15 + counterButton.y), 2);
            altUnityDriver.WaitForObject(By.PATH, "//ButtonCounter/Text[@text=2]");
        }
        ...
        public void TestKeyDownAndKeyUpMouse0()
        {
            ...
            altUnityDriver.MoveMouse(capsule.getScreenPosition(), 0.1f);
            Thread.Sleep(400);
            altUnityDriver.KeyDown(AltKeyCode.Mouse0);
            altUnityDriver.KeyUp(AltKeyCode.Mouse0);
            capsule = altUnityDriver.FindObject(By.NAME, "Capsule");
            var finalCapsulePosition = capsule.getWorldPosition();
            Assert.AreNotEqual(initialCapsulePosition, finalCapsulePosition);
        }
        ...
        {
            Assert.Throws<AltCameraNotFoundException>(() => altUnityDriver.FindObject(By.NAME, "Capsule", By.NAME, "Camera"));
        }
        [Test]
        ...
        public void TestSetCommandTimeout()
        {
            ...
            Assert.Throws<CommandResponseTimeoutException>(() => altUnityDriver.Tilt(new AltVector3(1, 1, 1), 3, true));
            altUnityDriver.SetCommandResponseTimeout(60);
        }
        ...
        public void TestKeysDown()
        {
            ...
            var finalPropertyValue = altUnityObject.GetComponentProperty<string>("AltExampleScriptCapsule", "stringToSetFromTests", "Assembly-CSharp");
        ...
        {
            var counterButton = altUnityDriver.FindObject(By.NAME, "ButtonCounter");
            var element = altUnityDriver.FindObjectAtCoordinates(new AltVector2(80 + counterButton.x, 15 + counterButton.y));
        ...
        {
            var counterButton = altUnityDriver.FindObject(By.NAME, "ButtonCounter");
            var element = altUnityDriver.FindObjectAtCoordinates(new AltVector2(-1, -1));
        ...
        {
            var altUnityObject = altUnityDriver.FindObject(By.NAME, "Capsule");
            altUnityObject.CallComponentMethod<string>("AltExampleScriptCapsule", "callJump", new object[] { }, assemblyName: "Assembly-CSharp");
            var capsuleInfo = altUnityDriver.FindObject(By.NAME, "CapsuleInfo");
            var text = capsuleInfo.GetText();
        ...
        {
            var icon = altUnityDriver.FindObject(By.NAME, "Icon");
            var id = altUnityDriver.BeginTouch(new AltVector2(icon.x - 25, icon.y + 25));
            altUnityDriver.EndTouch(id);
