...
namespace Altom.AltDriver.Tests
{
    ...
    public class TestForScene1TestSample
    {
        ...
        [TestCase(By.ID, "93d93e9f-e347-4ca9-8339-938149bb302b")]
        ...
        [TestCase("//DisabledObject", "DisabledObject")]
        [TestCase("//DisabledObject/DisabledChild", "DisabledChild")]
        ...
        [TestCase(By.PATH, "//DisabledObject", false)]
        public void TestWaitForObject(By by, string value, bool enabled = true)
        {
            int referenceId = altDriver.FindObject(By.PATH, "//Capsule").id;
            var timeStart = DateTime.Now;
            var altObject = altDriver.WaitForObject(By.PATH, "//Capsule", enabled: enabled);
        ...
        [Test]
        public void TestWaitForNonExistentObject()
        {
            Assert.Throws<WaitTimeOutException>(() => altDriver.WaitForObject(By.PATH, "//NonExistent", timeout: 2));
        }

        [TestCase(10, -1)]
        [TestCase(-1, 5)]
        public void TestWaitForObjectInvalidParams(int timeout, int interval)
        {
            Assert.Throws<ArgumentOutOfRangeException>(() => altDriver.WaitForObject(By.PATH, "//Capsule", timeout: timeout, interval: interval));
        }
        ...
        [TestCase(By.TEXT, "Capsule Info", "//CapsuleInfo")] // text area
        [TestCase(By.TEXT, "Change Camera Mode", "//Canvas/Button/Text")] // button with text
        public void TestFindObjects(By by, string value, string path, int expectedCount = 1)
        {
            var expectedObject = altDriver.FindObject(By.PATH, path);
            var altObjects = altDriver.FindObjects(by, value);
            Assert.NotNull(altObjects);
            Assert.AreEqual(expectedCount, altObjects.Count());
            Assert.AreEqual(expectedObject.id, altObjects[0].id);
        }

        [TestCase(By.PATH, "//*[@tag=plane]", "/Plane", "/UIWithWorldSpace/Plane")]
        [TestCase(By.PATH, "//*[@tag=plane][@layer=Default]", "/Plane", "/UIWithWorldSpace/Plane")]
        [TestCase(By.PATH, "//*[@tag=plane][@layer=Default][@name=Plane]", "/Plane", "/UIWithWorldSpace/Plane")]
        [TestCase(By.PATH, "//*[@tag=plane][@layer=Default][@name=Plane][@component=MeshCollider]", "/Plane", "/UIWithWorldSpace/Plane")]
        [TestCase(By.PATH, "//*[contains(@tag,pla)]", "/Plane", "/UIWithWorldSpace/Plane")]
        [TestCase(By.PATH, "//*[contains(@name,Cap)]", "//Capsule", "//CapsuleInfo")]
        [TestCase(By.PATH, "//*[contains(@tag,pla)][contains(@layer,Def)]", "/Plane", "/UIWithWorldSpace/Plane")]
        [TestCase(By.PATH, "//*[contains(@tag,pla)][contains(@layer,Def)][contains(@name,Pla)]", "/Plane", "/UIWithWorldSpace/Plane")]
        [TestCase(By.PATH, "//*[contains(@tag,pla)][contains(@layer,Def)][contains(@name,Pla)][contains(@component,MeshColl)]", "/Plane", "/UIWithWorldSpace/Plane")]
        [TestCase(By.TAG, "plane", "/Plane", "/UIWithWorldSpace/Plane")]
        public void TestFindObjects2(By by, string value, string path1, string path2, int expectedCount = 2)
        {
        ...
        [TestCase(By.PATH, "//DisabledObject")]
        [TestCase(By.PATH, "//DisabledObject/DisabledChild")]
        public void TestFindNonExistentObjects(By by, string value)
        {
            var altObjects = altDriver.FindObjects(by, value);
        ...
        [TestCase(By.LAYER, "Default")]
        [TestCase(By.ID, "93d93e9f-e347-4ca9-8339-938149bb302b")]
        public void TestFindObjectsByCamera(By cameraBy, string cameraValue)
        {
            int referenceId = altDriver.FindObject(By.PATH, "//Capsule").id;
            var altObjects = altDriver.FindObjects(By.PATH, "//Capsule", cameraBy, cameraValue);
            Assert.NotNull(altObjects);
            Assert.AreEqual(referenceId, altObjects[0].id);
            Assert.AreEqual(1, altObjects.Count());
        }

        [TestCase("//DisabledObject", "DisabledObject")]
        [TestCase("//DisabledObject/DisabledChild", "DisabledChild")]
        public void TestFindDisabledObjects(string path, string name)
        {
            var altObjects = altDriver.FindObjects(By.PATH, path, enabled: false);
            Assert.NotNull(altObjects);
            Assert.AreEqual(name, altObjects[0].name);
            Assert.AreEqual(1, altObjects.Count());
        }
