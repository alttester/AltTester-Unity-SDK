...
namespace AltTester.AltTesterSDK.Driver.Commands
{
    public class AltRotateXRController : AltBaseCommand
    {
        ...
        public AltRotateXRController(IDriverCommunication commHandler, AltXRController controller, AltVector2 rotation, float duration, bool wait) : base(commHandler)
        {
