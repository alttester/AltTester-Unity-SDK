...
#pragma warning disable CS0618
    ...
    public void TestCreatingStars()
    {
       ...
       AltUnityDriver.MoveMouse(new UnityEngine.Vector2(pressingpoint1.x, pressingpoint1.y), 1);
       Thread.Sleep(1500);
       ...
       AltUnityDriver.MoveMouseAndWait(new UnityEngine.Vector2(pressingpoint2.x, pressingpoint2.y), 1);
