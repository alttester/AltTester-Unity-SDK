...
class AltElement(object):
    ...
    def call_component_method(self, component_name, method_name, parameters,type_of_parameters=''):
        alt_object = self.toJSON()
        action_info = '{"component":"' + component_name + '", "method":"' + method_name + '", "parameters":"' + parameters + '", "typesofparameters":"' + type_of_parameters +'"}'
...
class AltrunUnityDriver(object):
    ...
    def call_static_methods(self, type_name, method_name, parameters, type_of_parameters = ''):
        action_info = '{"component":"' + type_name + '", "method":"' + method_name + '", "parameters":"' + parameters + '", "typesofparameters":"' + type_of_parameters +'"}'
