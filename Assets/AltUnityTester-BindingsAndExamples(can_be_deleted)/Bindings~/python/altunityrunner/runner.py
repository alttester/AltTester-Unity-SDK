...
class AltrunUnityDriver(object):
    ...
    def move_touch(self, positions, duration_in_secs):
        return MovingTouch(self.socket,self.request_separator,self.request_end,positions,duration_in_secs).execute()

    def move_touch_and_wait(self, positions, duration_in_secs):
        return MovingTouchAndWait(self.socket,self.request_separator,self.request_end,positions,duration_in_secs).execute()
