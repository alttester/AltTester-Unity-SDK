...
class MovingTouch(BaseCommand):
    def __init__(self, socket, request_separator, request_end, positions, duration_in_secs):
        super(MovingTouch, self).__init__(socket, request_separator, request_end)
    ...
    def execute(self):
        ...
        data = self.send_data(self.create_command('movingTouchChain', self.duration_in_secs, moving_position))
