public class WaitForElementWithText : AltBaseCommand
{
    string name;
    string cameraName;
    string text;
    ...
    public WaitForElementWithText(SocketSettings socketSettings, string name, string text, string cameraName, bool enabled, double timeout, double interval) : base(socketSettings)
    {
        this.name = name;
