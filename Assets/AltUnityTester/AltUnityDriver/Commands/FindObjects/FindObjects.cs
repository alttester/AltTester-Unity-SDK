public class FindObjectsDriver:BaseFindObjects
{
    By  by;
    string value;
    string cameraName;
    ...
    public FindObjectsDriver(SocketSettings socketSettings, By by, string value, string cameraName, bool enabled) : base(socketSettings)
    {
        this.by = by;
        this.value = value;
