public class WaitForObjectWhichContains: BaseFindObjects
{
    ...
    public WaitForObjectWhichContains(SocketSettings socketSettings, By by, string value, string cameraName, bool enabled, double timeout, double interval) : base(socketSettings)
    {
        this.by = by;
        this.value = value;
