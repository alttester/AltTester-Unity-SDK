...
public class AltUnityGetScreenshot : AltUnityCommandReturningAltElement
{
    ...
    public AltUnityGetScreenshot(SocketSettings socketSettings, int id, Assets.AltUnityTester.AltUnityDriver.UnityStruct.AltUnityColor color, float width, AltUnityVector2 size, int screenShotQuality) : base(socketSettings)
    {
        this.size = size;
        this.color = color;
        this.width = width;
    ...
    public AltUnityGetScreenshot(SocketSettings socketSettings, AltUnityVector2 coordinates, Assets.AltUnityTester.AltUnityDriver.UnityStruct.AltUnityColor color, float width, AltUnityVector2 size, int screenShotQuality) : base(socketSettings)
    {
