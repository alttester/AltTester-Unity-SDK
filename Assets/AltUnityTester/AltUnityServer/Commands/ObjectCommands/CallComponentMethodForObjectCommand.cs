...
{
    class CallComponentMethodForObjectCommand: ReflectionMethodsCommand
    {
        string altObjectString;
        string actionString;

        public CallComponentMethodForObjectCommand(string altObjectString, string actionString)
        {
