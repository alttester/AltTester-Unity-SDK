...
{
    class HightlightObjectFromCoordinatesCommand:Command
    {
        ...
        public HightlightObjectFromCoordinatesCommand(Vector2 screenCoordinates, string colorAndWidth, Vector2 size, AltClientSocketHandler handler)
        {
