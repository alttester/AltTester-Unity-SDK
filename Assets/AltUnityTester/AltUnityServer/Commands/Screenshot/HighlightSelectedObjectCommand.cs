...
{
    class HighlightSelectedObjectCommand:Command
    {
        int id;
        ...
        public HighlightSelectedObjectCommand(int id, string colorAndWidth, Vector2 size, AltClientSocketHandler handler)
        {
            this.id = id;
