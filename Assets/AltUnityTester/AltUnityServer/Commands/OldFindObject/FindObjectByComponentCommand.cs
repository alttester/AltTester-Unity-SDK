...
{
    class FindObjectByComponentCommand:ReflectionMethodsCommand
    {
        string methodParameters;

        public FindObjectByComponentCommand(string methodParameters)
        {
        ...
        public override string Execute()
        {
            ...
            UnityEngine.Debug.Log("find object by component " + componentTypeName);
