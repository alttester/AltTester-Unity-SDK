...
{
    class FindObjectByNameCommand : FindObjectsOldWayCommand
    {
        string methodParameters;

        public FindObjectByNameCommand(string methodParameters)
        {
        ...
        public override string Execute()
        {
            ...
            UnityEngine.Debug.Log("find object by name " + objectName);
