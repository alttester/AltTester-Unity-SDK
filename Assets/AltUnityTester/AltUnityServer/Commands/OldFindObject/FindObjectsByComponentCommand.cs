...
{
    class FindObjectsByComponentCommand:ReflectionMethodsCommand
    {
        string methodParameters;

        public FindObjectsByComponentCommand(string methodParameters)
        {
        ...
        public override string Execute()
        {
            ...
            UnityEngine.Debug.Log("find objects by component " + componentTypeName);
