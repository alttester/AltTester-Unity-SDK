...
{
    class PointerUpFromObjectCommand:Command
    {
        AltUnityObject altUnityObject;

        public PointerUpFromObjectCommand(AltUnityObject altUnityObject)
        {
        ...
        {
            UnityEngine.Debug.Log("PointerUp object: " + altUnityObject);
