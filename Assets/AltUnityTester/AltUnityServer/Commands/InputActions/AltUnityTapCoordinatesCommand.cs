...
{
    public class AltUnityTapCoordinatesCommand : AltUnityCommand
    {
        ...
        public AltUnityTapCoordinatesCommand(AltClientSocketHandler handler, params string[] parameters) : base(parameters, 6)
        {
        ...
        {
#if ALTUNITYTESTER
            Input.TapCoordinates(position, count, interval, onFinish);
            return "Ok";
#else
