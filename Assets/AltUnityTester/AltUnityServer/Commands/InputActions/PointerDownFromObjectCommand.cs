...
{
    class PointerDownFromObjectCommand:Command
    {
        AltUnityObject altUnityObject;

        public PointerDownFromObjectCommand(AltUnityObject altUnityObject)
        {
        ...
        {
            UnityEngine.Debug.Log("PointerDown object: " + altUnityObject);
