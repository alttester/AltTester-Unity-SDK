...
public class AltUnityRunner : UnityEngine.MonoBehaviour, AltIClientSocketHandlerDelegate
{
        ...
        try
        {
            switch (pieces[0])
            {
                ...
                case "tapObject":
                    ...
                    command = new Tap(altUnityObject);
                    break;
                ...
                case "callComponentMethodForObject":
                    command = new CallComponentMethodForObject(pieces[1], pieces[2]);
                    break;
                ...
                case "clickEvent":
                    ...
                    break;
                case "tapScreen":
                    command = new ClickOnScreenAtXy(pieces[1], pieces[2]);
                    break;
                case "dragObject":
                ...
                case "movingTouch":
                    ...
                    command = new SetMovingTouch(start2, end2, pieces[3]);
                    break;
                case "loadScene":
                    command = new Assets.AltUnityTester.AltUnityServer.Commands.LoadScene(pieces[1]);
                    break;
                case "setTimeScale":
                ...
                case "scrollMouse":
                    ...
                    duration = Newtonsoft.Json.JsonConvert.DeserializeObject<float>(pieces[2]);
                    command = new ScrollMouse(scrollValue, duration);
                    break;
                case "findObject":
                    methodParameters = pieces[1] + requestSeparatorString + pieces[2] + requestSeparatorString + pieces[3];
    ...
    public System.Collections.IEnumerator HighLightSelectedObjectCorutine(UnityEngine.GameObject gameObject, UnityEngine.Color color, float width, UnityEngine.Vector2 size, AltClientSocketHandler handler)
    {
        ...
        else
        {
            ...
            {
                var response= new GetScreenshot(size,handler).Execute();
