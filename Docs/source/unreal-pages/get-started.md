...
```
- **Move the AltTester-Unreal-SDK folder**: Place the **_AltTester-Unreal-SDK_** folder into the ***UE\_5.x\\Engine\\Plugins\\Marketplace*** directory (**Note:** If the **_Marketplace_** folder does not exist, create it manually).
