...
configuration options of AltTester® Unreal SDK.
...
When you run your app instrumented with AltTester® Unreal SDK on a device, you need
...
```eval_rst
.. note::
    The default port on which the AltTester® Unreal SDK is running is 13000.
