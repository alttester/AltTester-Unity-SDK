...
-   Please make sure all the files that you add will have the copyright info added like in the following [example file](https://github.com/alttester/AltTester-Unity-SDK/blob/development/Assets/AltTester/Runtime/Commands/AltId.cs)
