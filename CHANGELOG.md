...
- "Add ability to switch from custom input to normal input in instrumented builds" !1041
- "Command to get application ScreenSize" !811
- "Implement update for AltObject" !768
- "CheckDesktopVersionRequest - Add validation for regex match" !1048
- "Add a getAltDriver tests helper for Java" !1031
- "Add a GetAltDriver tests helper for C#" !1032

## Bug fixes and improvements

- "Change websocket-sharp.dll to altwebsocket-sharp.dll" !1053
- "Compiling error when project only has 1 active input system" !1042
- "Set server logging back to default at the end of testSetServerLogging" !1027
