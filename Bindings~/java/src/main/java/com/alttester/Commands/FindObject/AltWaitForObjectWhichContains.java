...
public class AltWaitForObjectWhichContains extends AltBaseFindObject {
  ...
  public AltWaitForObjectWhichContains(
      IMessageHandler messageHandler, AltWaitForObjectsParams altWaitForObjectsParameters) {
  ...
  public AltObject Execute() throws WaitTimeOutException {
    ...
    throw new WaitTimeOutException(
        "Element "
            + altWaitForObjectsParameters.getAltFindObjectsParameters().getPath()
            + " still not found after "
            + altWaitForObjectsParameters.getTimeout()
            + " seconds");
  }
}
