...
public class AltClickCoordinates extends AltBaseCommand {
    ...
    public AltClickCoordinates(AltBaseSettings altBaseSettings, AltTapClickCoordinatesParameters parameters) {
    ...
    public void Execute() {
        ...
        SendCommand("clickCoordinates", position, String.valueOf(this.parameters.getCount()),
