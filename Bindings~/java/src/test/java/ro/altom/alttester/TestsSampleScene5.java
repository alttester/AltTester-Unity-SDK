...
public class TestsSampleScene5 {
    ...
    public void TestMovementCube() throws InterruptedException {
        ...
        altDriver
                .pressKey(new AltPressKeyParams.Builder(AltKeyCode.O).withDuration(1).withPower(1).build());
    ...
    public void TestPowerJoystick() {
        ...
        for (AltKeyCode key : KeyToPressForButtons) {
            altDriver.pressKey(new AltPressKeyParams.Builder(key).withPower(0.5f).withDuration(0.1f).build());
