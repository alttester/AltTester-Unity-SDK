...
public class TestsSampleScene1 {
        ...
        public void testWaitForCurrrentSceneToBeANonExistingScene() {
                ...
                try {
                        AltWaitForCurrentSceneToBeParameters params = new AltWaitForCurrentSceneToBeParameters.Builder(
                                        name)
                                                        .withTimeout(1).build();
        ...
        public void testWaitForNonExistingElementWhereNameContains() {
                String name = "xyz";
                AltFindObjectsParameters findObjectsParams = new AltFindObjectsParameters.Builder(By.NAME, name)
                                .build();
        ...
        public void testCallMethodWithParameters() throws Exception {
                ...
                AltFindObjectsParameters altFindObjectsParameters = new AltFindObjectsParameters.Builder(
                                ...
                                "Capsule").build();
                AltUnityObject altElement = altUnityDriver.findObject(altFindObjectsParameters);
                assertNull(altElement.callComponentMethod(componentName, methodName, parameters, Void.class));
        }
        ...
        public void testCallMethodAssmeblyNotFound() {
                ...
                AltFindObjectsParameters altFindObjectsParameters = new AltFindObjectsParameters.Builder(
                                ...
                                "Capsule").build();
                AltUnityObject altElement = altUnityDriver.findObject(altFindObjectsParameters);
                altElement.callComponentMethod("RandomAssembly", componentName, methodName, parameters, new String[] {},
                                Void.class);
        }
        ...
        public void testButtonClickWithSwipe() throws Exception {
                AltUnityObject button = altUnityDriver
                                .findObject(new AltFindObjectsParameters.Builder(AltUnityDriver.By.NAME, "UIButton")
                                                .build());
                altUnityDriver.holdButton(
                                new AltHoldParameters.Builder(button.getScreenPosition()).withDuration(1).build());
                AltUnityObject capsuleInfo = altUnityDriver
                                .findObject(new AltFindObjectsParameters.Builder(AltUnityDriver.By.NAME, "CapsuleInfo")
                                                .build());
        ...
        public void TestCallStaticMethod() throws Exception {
                altUnityDriver.callStaticMethod(
                                new AltCallStaticMethodParameters.Builder("UnityEngine.PlayerPrefs", "SetInt",
                                                new Object[] { "Test", "1" }).build(),
                                String.class);
                int a = altUnityDriver
                                .callStaticMethod(new AltCallStaticMethodParameters.Builder("UnityEngine.PlayerPrefs",
        ...
        public void TestCallMethodWithAssembly() {
                ...
                capsule.callComponentMethod("UnityEngine.CoreModule", "UnityEngine.Transform", "Rotate",
        ...
        public void TestAcceleration() throws InterruptedException {
                ...
                altUnityDriver
                                .tilt(new AltTiltParameters.Builder(new Vector3(1, 1, 1)).withDuration(1)
        ...
        public void TestFindObjectWithCameraId() {
                ...
                AltFindObjectsParameters altFindObjectsParametersCampsule = new AltFindObjectsParameters.Builder(
                                By.COMPONENT,
        ...
        public void TestWaitForObjectWithCameraId() {
                ...
                AltFindObjectsParameters altFindObjectsParametersCamera = new AltFindObjectsParameters.Builder(By.PATH,
                                "//Camera").build();
                AltUnityObject camera = altUnityDriver.findObject(altFindObjectsParametersCamera);
                AltFindObjectsParameters altFindObjectsParametersCapsule = new AltFindObjectsParameters.Builder(
                                By.COMPONENT,
                                "CapsuleCollider").withCamera(By.ID, String.valueOf(camera.id)).build();
                AltWaitForObjectsParameters altWaitForObjectsParameters = new AltWaitForObjectsParameters.Builder(
                ...
                altFindObjectsParametersCapsule = new AltFindObjectsParameters.Builder(By.COMPONENT, "CapsuleCollider")
                                .withCamera(By.ID, String.valueOf(camera2.id)).build();
                altWaitForObjectsParameters = new AltWaitForObjectsParameters.Builder(altFindObjectsParametersCapsule)
                                .build();
        ...
        public void TestLoadAdditiveScenes() throws Exception {
                ...
                AltLoadSceneParameters altLoadSceneParameters = new AltLoadSceneParameters.Builder(
        ...
        public void TestGetComponentPropertyComplexClass() throws Exception {
                ...
                AltFindObjectsParameters altFindObjectsParameters = new AltFindObjectsParameters.Builder(By.NAME,
                                "Capsule")
                                                .build();
                AltUnityObject altElement = altUnityDriver.findObject(altFindObjectsParameters);
                assertNotNull(altElement);
        ...
        public void TestTapCoordinates() {
                AltFindObjectsParameters findCapsuleParameters = new AltFindObjectsParameters.Builder(By.NAME,
                                "Capsule")
                                                .build();
                ...
                AltWaitForObjectsParameters waitParams = new AltWaitForObjectsParameters.Builder(
                                findCapsuleInfoParameters)
                                                .build();
        ...
        public void testGetStaticProperty() {
                ...
                AltGetComponentPropertyParameters altGetComponentPropertyParameters = new AltGetComponentPropertyParameters.Builder(
                                "UnityEngine.Screen", "currentResolution.width").withAssembly("UnityEngine.CoreModule")
                                                .build();
        ...
        @Test(expected = CommandResponseTimeoutException.class)
