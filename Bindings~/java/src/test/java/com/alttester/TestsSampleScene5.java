...
public class TestsSampleScene5 extends BaseTest {
  ...
  public void TestMovementCube() throws InterruptedException {
    ...
    AltFindObjectsParams altFindObjectsParameters1 =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Player2").build();
    ...
    AltFindObjectsParams altFindObjectsParameters2 =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Player1").build();
  ...
  public void TestCreatingStars() throws InterruptedException {
    ...
    AltFindObjectsParams altFindObjectsParameters1 =
        new AltFindObjectsParams.Builder(By.NAME, "Star").build();
    ...
    AltFindObjectsParams params =
        new AltFindObjectsParams.Builder(By.NAME, "PressingPoint1")
    ...
    params =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "PressingPoint2")
  ...
  public void TestPowerJoystick() {
    ...
    AltLoadSceneParams loadSceneParams =
        new AltLoadSceneParams.Builder("Scene 5 Keyboard Input").build();
    altDriver.loadScene(loadSceneParams);

    AltFindObjectsParams findObjectParams =
        new AltFindObjectsParams.Builder(By.NAME, "AxisName").build();
  ...
  public void TestKeyDownAndKeyUp() throws Exception {
    AltFindObjectsParams altFindObjectsParameters1 =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "LastKeyDownValue").build();
    AltFindObjectsParams altFindObjectsParameters2 =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "LastKeyUpValue").build();
    AltFindObjectsParams altFindObjectsParameters3 =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "LastKeyPressedValue").build();
