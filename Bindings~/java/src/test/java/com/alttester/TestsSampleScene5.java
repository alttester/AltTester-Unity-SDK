...
public class TestsSampleScene5 extends BaseTest {
    ...
    public void TestMovementCube() throws InterruptedException {
        ...
        AltFindObjectsParams altFindObjectsParameters1 = new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Player2")
                .build();
        ...
        AltFindObjectsParams altFindObjectsParameters2 = new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Player1")
                .build();
        ...
        altDriver.scroll(
                new AltScrollParams.Builder().withSpeed(30).withDuration(20).withWait(false).build());
        altDriver.pressKey(
                new AltPressKeyParams.Builder(AltKeyCode.K)
                        .withDuration(2)
                        .withPower(1)
                        .withWait(false)
                        .build());
        ...
        altDriver.pressKey(
                new AltPressKeyParams.Builder(AltKeyCode.O).withDuration(1).withPower(1).build());
    ...
    public void TestCameraMovement() throws InterruptedException {
        ...
        altDriver.pressKey(
                new AltPressKeyParams.Builder(AltKeyCode.W)
                        .withDuration(2)
                        .withPower(1)
                        .withWait(false)
                        .build());
    ...
    public void TestUpdateAltObject() throws InterruptedException {
        ...
        AltFindObjectsParams altFindObjectsParameters = new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Player1")
                .build();
    ...
    public void TestCreatingStars() throws InterruptedException {
        ...
        AltFindObjectsParams altFindObjectsParameters1 = new AltFindObjectsParams.Builder(By.NAME, "Star").build();
        ...
        params = new AltFindObjectsParams.Builder(AltDriver.By.NAME, "PressingPoint2")
                .withCamera(AltDriver.By.NAME, "Player2")
                .build();
    ...
    public void TestScroll() throws InterruptedException {
        AltFindObjectsParams altFindObjectsParameters = new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Player2")
                .build();
        ...
        altDriver.scroll(
                new AltScrollParams.Builder().withSpeed(4).withDuration(2).withWait(false).build());
        Thread.sleep(2000);
    ...
    public void TestKeyDownAndKeyUp() throws Exception {
        AltFindObjectsParams altFindObjectsParameters1 = new AltFindObjectsParams.Builder(AltDriver.By.NAME,
                "LastKeyDownValue").build();
        AltFindObjectsParams altFindObjectsParameters2 = new AltFindObjectsParams.Builder(AltDriver.By.NAME,
                "LastKeyUpValue").build();
        AltFindObjectsParams altFindObjectsParameters3 = new AltFindObjectsParams.Builder(AltDriver.By.NAME,
                "LastKeyPressedValue").build();
