...
public class TestsNotifications {
  ...
  private void waitForNotificationToBeSent(
      String lastSceneLoaded, String expectedValue, float timeout) throws Exception {
  ...
  public void testUnloadSceneNotification() throws Exception {
    ...
    waitForNotificationToBeSent(
        MockNotificationCallBacks.lastUnloadedScene, "Scene 2 Draggable Panel", 10);
