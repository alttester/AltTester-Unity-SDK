...
public class TestsSampleScene3 extends BaseTest {
  ...
  private AltObject FindObject(By by, String name) {
    AltFindObjectsParams altElementParams = new AltFindObjectsParams.Builder(by, name).build();
    return altDriver.findObject(altElementParams);
  }

  private void dropImage(
      String dragLocationName, String dropLocationName, float duration, boolean wait) {
