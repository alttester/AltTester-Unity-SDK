...
public class TestsSampleScene3 {
    ...
    public void testMultipleDragAndDrop() throws Exception {
        ...
        altDriver
                .swipe(new AltSwipeParams.Builder(altElement1.getScreenPosition(),
        ...
        AltSprite imageSource = altDriver.findObject(altFindObjectsParameters1)
                .getComponentProperty(
                        new AltGetComponentPropertyParams.Builder("UnityEngine.UI.Image",
                                "sprite", "UnityEngine.UI").build(),
                        AltSprite.class);
        ...
        imageSource = altDriver.findObject(altFindObjectsParameters3).getComponentProperty(
                new AltGetComponentPropertyParams.Builder("UnityEngine.UI.Image", "sprite",
                        "UnityEngine.UI").build(),
                AltSprite.class);
    ...
    public void testTestPointerEnterAndExit() throws Exception {
        ...
        AltColor color3 = altElement.getComponentProperty(
                new AltGetComponentPropertyParams.Builder("AltExampleScriptDropMe", "highlightColor",
                        ...
                        .build(),
                AltColor.class);
        assertTrue(color3.r != color2.r || color3.g != color2.g || color3.b != color2.b
                || color3.a != color2.a);
        assertTrue(color1.r == color3.r && color1.g == color3.g && color1.b == color3.b
                && color1.a == color3.a);
    }
    ...
    public void testMultipleDragAndDropWaitWithMultipointSwipe() throws InterruptedException {
        ...
        altDriver.multipointSwipe(
                new AltMultiPointSwipeParams.Builder(positions).withDuration(2).withWait(false)
                        .build());
