...
public class TestsSampleScene2 extends BaseTest {
    ...
    public void testClosePanel() throws Exception {
        ...
        AltFindObjectsParams findObjectsParameters = new AltFindObjectsParams.Builder(By.NAME, "Panel Drag Area")
                .build();
        AltWaitForObjectsParams params = new AltWaitForObjectsParams.Builder(findObjectsParameters).withInterval(2)
                .build();
        ...
        AltFindObjectsParams altFindObjectsParameters2 = new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Button")
                .build();
        AltFindObjectsParams altFindObjectsParameters1 = new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Panel")
                .build();
