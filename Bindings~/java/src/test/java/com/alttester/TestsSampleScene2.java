...
public class TestsSampleScene2 extends BaseTest {
  ...
  public void testResizePanel() throws Exception {
    ...
    AltFindObjectsParams altFindObjectsParameters1 =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Resize Zone").build();
  ...
  public void testMovePanel() throws Exception {
    ...
    AltFindObjectsParams altFindObjectsParameters1 =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Drag Zone").build();
    AltObject altElement = altDriver.findObject(altFindObjectsParameters1);
    Vector2 start = altElement.getScreenPosition();
    Vector2 end = new Vector2(start.x + 200, start.y + 200);
    altDriver.swipe(new AltSwipeParams.Builder(start, end).withDuration(2).withWait(false).build());
  ...
  public void testResizePanelWithMultipointSwipe() throws Exception {
    ...
    altDriver.multipointSwipe(
        new AltMultiPointSwipeParams.Builder(positions).withDuration(3).build());
  ...
  public void testClosePanel() throws Exception {
    ...
    AltFindObjectsParams findObjectsParameters =
        new AltFindObjectsParams.Builder(By.NAME, "Panel Drag Area").build();
    AltWaitForObjectsParams params =
        new AltWaitForObjectsParams.Builder(findObjectsParameters).withInterval(2).build();
    altDriver.waitForObject(params);

    AltFindObjectsParams findObjectParams =
        new AltFindObjectsParams.Builder(By.NAME, "Panel").build();
    ...
    AltFindObjectsParams altFindObjectsParameters1 =
        new AltFindObjectsParams.Builder(AltDriver.By.NAME, "Panel").build();
  ...
  public void testPointerDownFromObject() throws InterruptedException {
    ...
    AltColor color1 =
        panel.getComponentProperty(
            new AltGetComponentPropertyParams.Builder(
                    "AltExampleScriptPanel", "normalColor", "Assembly-CSharp")
                .build(),
            AltColor.class);
    panel.pointerDown();
    Thread.sleep(1000);
    AltColor color2 =
        panel.getComponentProperty(
            new AltGetComponentPropertyParams.Builder(
                    "AltExampleScriptPanel", "highlightColor", "Assembly-CSharp")
                .build(),
            AltColor.class);
    assertTrue(
        color1.r != color2.r
