...
from alttester.commands.InputActions.key_down import *
from alttester.commands.InputActions.key_up import *
...
from alttester.commands.InputActions.press_key import *
