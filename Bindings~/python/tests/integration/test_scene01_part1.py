...
class TestScene01Part1:
    ...
    def test_find_object_which_contains(self, partial_name):
        plane = self.altdriver.find_object_which_contains(
    ...
    def test_find_objects_which_contain_by_name(self):
        alt_objects = self.altdriver.find_objects_which_contain(
            By.NAME, "Capsule")
    ...
    def test_double_tap(self):
        ...
        counter_button_text = self.altdriver.find_object(
    ...
    def test_wait_for_component_property_get_property_as_string(self):
        ...
        Canvas.wait_for_component_property("UnityEngine.RectTransform", "rect.x", "-960.0", "UnityEngine.CoreModule", 1, get_property_as_string=True)

        Canvas.wait_for_component_property("UnityEngine.RectTransform", "hasChanged", True, "UnityEngine.CoreModule", 1, get_property_as_string=True)

        Canvas.wait_for_component_property("UnityEngine.RectTransform", "constrainProportionsScale", False, "UnityEngine.CoreModule", 1, get_property_as_string=True)

        Canvas.wait_for_component_property("UnityEngine.RectTransform", "transform", "[[],[[]],[[]],[[]],[[]],[[],[],[]],[[[],[],[]]],[],[],[[]],[[]],[[]]]", "UnityEngine.CoreModule", 1, get_property_as_string=True)

        Canvas.wait_for_component_property("UnityEngine.RectTransform", "name", "Canvas", "UnityEngine.CoreModule", 1, get_property_as_string=True)
    ...
    def test_call_component_method(self):
        ...
        assert self.altdriver.find_object(
