...
class TestScene02:
    ...
    def test_resize_panel(self):
        alt_object = self.alt_driver.find_object(AltBy.name("Resize Zone"))
    ...
    def test_pointer_down_from_object(self):
        panel = self.alt_driver.find_object(AltBy.name("Panel"))
    ...
    def test_new_touch_commands(self):
        draggable_area = self.alt_driver.find_object(AltBy.name("Drag Zone"))
