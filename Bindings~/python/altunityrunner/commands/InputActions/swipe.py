...
class Swipe(BaseCommand):
    ...
    def execute(self):
        ...
        logger.trace('Swipe from ' + start_position + ' to ' + end_position + ' with duration: ' + str(self.duration_in_secs) + ' secs')
        data = self.send_data(self.create_command('MultipointSwipe', start_position , end_position , str(self.duration_in_secs) ))
